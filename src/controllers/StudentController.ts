...
import IStudentModel = require("./../app/model/interfaces/IStudentModel");

class StudentController implements IBaseController<StudentBusiness> {
  create(req: express.Request, res: express.Response): void {
    try {
      console.log("Inside studentController : create", req);
      const student: IStudentModel = <IStudentModel>req.body;
...
//   findCourseById(req: express.Request, res: express.Response): void {
//     try {
//       var _id: string = req.params._id;
//       var studentBusiness = new StudentBusiness();
//       studentBusiness.findCourseById(_id, (error, result) => {
//         if (error) res.send({ error: "error" });
//         else res.send(result);
//       });
//     } catch (e) {
